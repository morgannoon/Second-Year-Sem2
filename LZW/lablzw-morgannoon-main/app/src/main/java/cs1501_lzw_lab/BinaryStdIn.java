...
public final class BinaryStdIn {
    ...
    /**
     * Added by Dr. Farnan to help with Gradle support
     * 
     * @param newIn New input stream to use
     */
     ...
     * @throws IllegalArgumentException if there are fewer than r bits available on
     *                                  standard input
     ...
     * @throws RuntimeExceptionArgument if there are fewer than 64 bits available on
     *                                  standard input
     */
